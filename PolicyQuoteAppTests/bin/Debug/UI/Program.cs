using InsurancePolicyQuote.Logic.Model.Enums;
using InsurancePolicyQuote.Model;
using InsurancePolicyQuote.UI;
using InsurancePolicyQuote.Utility;
using System;
using System.Collections.Generic;

namespace InsurancePolicyQuote
{
    class Program
    {          
        ...
        {           
            ...
            proposerMessages.MessageUser($"Vehicle Use: {vehicle.VehicleUsage.ToString()}");
            ...
            proposerMessages.MessageUser($"Cover Type: {cover.ToString()}");
